...
void man(char *name)
{
	...
	else if(strcmp(name,"write")==0)
	{
		...
		printf("Usage: write File name\n After this entre the data that we want to write\n");
	}
	...
	{
		printf("Description: Used to all close opened file\n");
	...
	while(1)
	{
		...
		else if(count==3)
		{
			if(strcmp(command[0],"creat")==0)
			{
				...
				printf("ERROR:Incorrect parameter\n");
			    if(ret==-2)
				printf("ERROR:There is no INODEn");
			    if(ret==-3)
			...
			else if(strcmp(command[0],"open")==0)
			{
				...
				printf("ERROR:Incorrect parameter\n");
			    if(ret==-2)
				printf("ERROR:File is no present\n");
			    if(ret==-3)
			    printf("ERROR: Permission denied\n");
				continue;
			}
